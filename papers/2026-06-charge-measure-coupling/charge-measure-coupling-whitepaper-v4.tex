...
surviving fifth-root pullback with the rotation-class coupling that $\Adams5$ destroys. That is
Schur--Siegel--Smyth trace-problem territory and is not closable by the methods here. By the
