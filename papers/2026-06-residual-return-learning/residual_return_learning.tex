...
$\sqrt5=\varphi-\psi$, and $R_1$ is conjugate to $-R$, where $R=\big(\begin{smallmatrix}0&1\\1&1\end{smallmatrix}\big)$ is the keystone
($R_1$ and $-R$ share $\charpoly=x^2+x-1$, and $R,-R$ both have discriminant $5$, so $R_1$ has the same self--action gap $\sqrt5$ as the keystone).
\end{proposition}
\begin{proof}
...
case $\{-\sqrt5,0,+\sqrt5\}$ and $R_1$ conjugate to $-R$ (same self--action gap $\sqrt5$ as the keystone); and the canonicalization ladder of
