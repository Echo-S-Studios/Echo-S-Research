...
\begin{theorem}[The even relational floor {$=\gp$}, given Schinzel (v2.3)]\label{thm:evenfloor}\tagF{}/\tagE{} \hx{EV-S1--S2, EV-W1--W2, EV-D1--D2, EV-F1--F3}
...
gap (W-\S5.2, W-\S22, ``over all charge-admissible''), now \tagF{} given Schinzel.
...
admissible half of the dichotomy is discharged \tagF{}-given-Schinzel (and, by
Remark~\ref{rem:evenlocalize}, internally except at $r=1$). What GAP-UNIV
...
no-Salem dichotomy, inadmissible half (Finding~\ref{find:gapdichotomy}) & scoped-external --- commutator & the free-commutator analysis (W-\S5.2): does the associative algebra generated by the $\otimes/\oplus$-images of the catalog contain a full matrix algebra? The admissible half is Corollary~\ref{cor:gapuniv}.\\[2pt]
