...
$0.045$ at $k=10$; its derivative in $k$ is negative throughout. The object that
...
realize it, with the tube quantity shrinking $0.167\to0.045$ as computed in
...
tube quantity $0.167\to0.045$\\[4pt]
...
with taper ($0.167\to0.045$) while the distance-only failure factor grows
